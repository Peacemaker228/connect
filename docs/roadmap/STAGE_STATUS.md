...
Next likely work:
- run two-user staging/local smoke for idle/reconnect profile readiness, member self-filtering, account identity, server rail unread, channel/member row unread, and Segment 196 title/divider regression
