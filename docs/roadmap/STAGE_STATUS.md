...
- newly recorded follow-up: single-user mention chips should navigate to the mentioned member's profile/conversation entry point while `@all` stays non-navigating
- next focused implementation target: decide between mention chip navigation and reply-to-message after Segment 213 verification/manual smoke
