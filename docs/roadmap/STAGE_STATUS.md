...
- run two/three-user mention attention smoke for plain unread, `@user`, `@all`, sender negative case, read clearing, reload restore, hidden/scrolled-up behavior, muted channel visual attention, and desktop runtime review
