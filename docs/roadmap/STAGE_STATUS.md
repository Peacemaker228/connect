...
- next focused implementation target: `customer-chat-send-button`; brief is ready at `docs/delegation/briefs/SEGMENT_BRIEF_209_CUSTOMER_CHAT_SEND_BUTTON.md`
- planned follow-up order after send button: `customer-link-rendering-basic`, then file-transfer policy/design, then reply-to-message
