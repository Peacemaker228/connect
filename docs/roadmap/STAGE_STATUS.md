...
- next focused implementation target after Segment 215 verification: reply attention/unread or reply navigation polish, unless manual smoke exposes a reply foundation blocker
