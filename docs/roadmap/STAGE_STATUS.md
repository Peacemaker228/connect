...
- next focused reply follow-up after Segment 218 smoke: decide whether history-loading/deep-link reply navigation is needed, otherwise continue with the next customer-priority chat polish item
