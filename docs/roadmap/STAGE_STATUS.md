...
- next focused implementation target after Segment 215 verification: reply preview mention rendering polish, then reply attention/unread or reply navigation polish, unless manual smoke exposes another reply foundation blocker
