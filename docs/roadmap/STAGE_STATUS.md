...
- next focused implementation target after Segment 216 verification: reply attention/unread or reply navigation polish, unless manual smoke exposes another reply foundation blocker
