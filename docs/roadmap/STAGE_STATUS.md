...
- run two-user notification smoke for channel/DM visible-active, hidden-active, muted, duplicate, reload/focus, and debug reason-code behavior
...
- after per-chat sound mute, continue to `customer-mentions-replies-attention` unless mention/reply attention becomes more urgent
