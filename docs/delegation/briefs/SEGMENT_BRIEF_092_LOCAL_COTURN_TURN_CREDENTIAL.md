...
Add local-only TURN credential support for future relay-path testing without production rollout, UI runtime switching, LiveKit removal, or production coturn deployment/config changes.
