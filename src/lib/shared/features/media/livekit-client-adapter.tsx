...
import { FC, type MouseEvent, useCallback, useMemo, useRef } from 'react'
...
export interface LiveKitClientAdapterProps {
  token: string
  video: boolean
  audio: boolean
  onLeave: () => void
...
export const LiveKitClientAdapter: FC<LiveKitClientAdapterProps> = ({ audio, video, token, onLeave }) => {
